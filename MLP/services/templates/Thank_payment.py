...
<body style="max-width: 600px; margin: auto; font-family: Satoshi, sans-serif;">
  <div>
    <table  style="background: #DEA500;color:white;height:100px"cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <!-- <div id="banner">
            <img src="images/image235.png" alt="image">
        </div> -->
        <div id="rohan">
            <h1>Hi {candidate_name} 👋</h1><br>
            <!-- <h1>We hope this message finds you well.</h1> -->
            <p>Great news! Your payment for the Medico plan has been successfully processed.
            Get ready to enjoy paid user features<br> and meet your match.</p>

            <div>
                <div> 
                        <img src="https://dev-medico.s3.ap-south-1.amazonaws.com/Frame1.png" alt="boy image" height="100%" width="100%">   
                </div>
                <br><br>
                <div>
                    <img src="https://dev-medico.s3.ap-south-1.amazonaws.com/Frame2.png" alt="boy image" height="100%" width="100%">
                </div>
        ...
        <div id="tati">
            <div>
                <p>Worry not if you haven't taken the premium plan and wish to upgrade, just
                click on plans and upgrade your plan by paying the difference amount (this 
                 option is available until 1 month of purchasing your plan)</p>
                
                <p>If you have any questions or need assistance, please don't hesitate to reach
                    out to us. We're here to ensure that your experience with Medico Life Partner
       ...
       <div id="moto2">
            ...
            <div >
                <p id="dolor">
                    ...
                    <span>+918591930074,+919137531284,+919324710288,+918591912971,<br>+919372822836</span> and <span>+919137401531</span></p>
            </div>
             <div>
