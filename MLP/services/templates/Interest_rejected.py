  ...
  <div>
    <table  style="background: #30BCC9;color:white;height:100px"cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <div id="rohan">
            ...
            <p style = "font-weight:200">We regret to inform you that your interest in {candidate_name} has not been
             accepted at this time on Medico Life Partner App. We understand that this maybe dissapointing,
               but we encourage you to continue exploring other profiles on our platform.</p>
            ...
            <div>
                ...
                <div id="pagalu">
                    ...
                    <div>
                        <!-- <img src="https://dev-medico.s3.ap-south-1.amazonaws.com/image56.png" alt="image"> -->
        ...
        <div id="tati">
            <div>
                <p style = "font-weight:200">Thank you for being a part of our Medico App. We remain
                commited to helping you find your ideal match within the
                medical community.</p>
            </div>
            <!-- <div>
