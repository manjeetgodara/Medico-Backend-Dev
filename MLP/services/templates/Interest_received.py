...
<body style="max-width: 600px; margin: auto; font-family: Satoshi, sans-serif;">
    <div>
      <div id="khushi" style="background-color: #F97FB3; text-align: center; color: white; max-height:100px">
        <div style="display: inline-block; margin: 10px 0 10px 10px;">  <img style="border-radius: 10px; width: 70px; height: 70px;" src="https://dev-medico.s3.ap-south-1.amazonaws.com/heartimage3.png" alt="">
        </div>
        <div style="display: inline-block; text-align: left; vertical-align: middle; margin-bottom: 55px;">
        ...
        <div id="banner" style="text-align: center;">
            <img style="margin:auto ; margin-top:60px" src="https://dev-medico.s3.ap-south-1.amazonaws.com/image235.png" alt="image">
        </div>
        <div id="rohan">
            <h1>Hi {name} 👋</h1>
            <h1>Exciting news! 🎉</h1><br>
            <p style="font-size: 20px; font-weight:200">We're thrilled to inform you that {candidate_name} has shown
              interest in your profile on Medico. This could be the start of 
                something special!</p>
        ...
        <div id="tati">
            <div>
                <p>Take the next step and explore this potential connection.Log
                in to your account now to view the profile and see if there's
                mutual interest.
                Remember, love could be just a click away.</p>
            </div>
