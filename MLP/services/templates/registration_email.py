...
#banner {
  height: 200px;
   background: linear-gradient(180deg, #FFAFD1 0%, #FFFFFF 100%);
...
<body style="max-width: 600px; margin: auto; font-family: Satoshi, sans-serif;">
  <div>
    <table  style="background:#30BCC9;color:white;height:100px"cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
        ...
        <!-- <div id="banner">
            <img src="https://dev-medico.s3.ap-south-1.amazonaws.com/image235.png" alt="image">
        </div> -->
        <div id="rohan">
            <h1>Hi {name} 👋</h1><br>
            <h1>Welcome aboard.🎉</h1><br>
            <p>You've successfully registered on Medico Life Partner, the ultimate platform
                for doctors seeking meaningful connections for matrimonial purposes within the medical community.
            </p><br>

            <div>  
                        <img src="https://dev-medico.s3.ap-south-1.amazonaws.com/Frame3.png" alt="boy image" height="100%" width="100%">

        </div>
        <div id="tati">
            <div>
                <p style="font-weight: 400; font-size:15px">Start exploring potential matches now and find your perfect Medico Partner!</p>
        ...
        <div class="Main" >
          <p style="text-align: left; margin-top:20px; display:block; margin-left: 20px;font-weight: 500; font-size: 18px;">Mobile number : {mobile}</p>
          <p style="text-align: left; margin-top:20px; display:block; margin-left: 20px;font-weight: 500; font-size: 18px;">Email id : {email}</p>
          <p style="text-align: left; margin-top:20px; display:block; margin-left: 20px;font-weight: 500; font-size: 18px;">Password : {password}</p><br>
          <p style="text-align: left; margin-top:20px; display:block; margin-left: 20px;font-weight: 300; font-size: 18px;">You can now login on the app via
          your registered mobile number or on the website with your email ID and password.</p>
       </div>
    ...
    If you no longer want to receive some email please click on <a href="">unsubscribe</a> to adjust your notification
            ...
            <div id="type" style="margin-left:25%;">
