...
<head>
    ...
    <title>Plan Expire Reminder</title>
...
#banner {
 ...
 /* background: linear-gradient(180deg, #FFAFD1 0%, #FFFFFF 100%); */
  background-image: url("https://dev-medico.s3.ap-south-1.amazonaws.com/backgound.png"); /* Replace with your image path */
  background-position: center;  /* Optional: centers the image horizontally and vertically */
...
#tati{
    ...
    max-width: 450px;
    margin:auto;
    background: linear-gradient(180deg, #f8c3c7 0%, #FFFFFF 90%);
    margin-bottom: 30px;
    margin-top: 40px;
}
  ...
  <div>
    <table  style="background:#30BCC9;color:white;height:100px"cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <div id="banner" style="text-align: center;">
            <img style="margin:auto ; margin-top:60px" src="https://dev-medico.s3.ap-south-1.amazonaws.com/clock.png" alt="image">
        </div>
        <div id="rohan">
            <h1>Hi {candidate_name} 👋</h1>
            <h1>Just a friendly heads-up! 😀</h1><br>
            <p>Just a friendly heads-up! Your Medico plan is set to expire in {remaining_days} days. Don't miss out
               on the opportunity to continue enjoying paid member features and finding your perfect 
               match within the medical community. 
            </p>
        </div>
        <div id="tati">
            <div>
                <p>Renew your subscription now to avoid any interruptions
                   in your matchmaking journey. 
                </p>
            </div>
